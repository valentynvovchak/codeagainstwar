...
function LearningBlock({ pageRefs }) {
  return (
    <div
      ...
      className="px-16 py-32 sm:py-10 md:py-14"
    >
      <a className="uppercase font-bold text-sm text-blue-700 pl-14">
        Learning
      </a>
      <p className="text-black text-3xl font-bold pl-14 mt-6 mb-6 sm:pl-4 sm:mb-4 sm:text-2xl">
        Improve your development skills by taking on challenges from real
        companies
      </p>
      <a className="font-bold text-md text-blue-700 pl-14 sm:w-36 sm:pl-0">
      ...
      <div className="mt-6 flex justify-between sm:flex-col md:flex-col">
        <div className="w-full ml-14 sm:ml-2 mb-6">
          <CodeWindow />
        </div>
        <div className="max-w-2xl pr-40 sm:pr-6 mt-8">
