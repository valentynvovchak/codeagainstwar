...
function CodeWindow() {
  return (
    <section>
      <div className="bg-gray-200 max-w-xl h-96 rounded-3xl relative flex flex-col">
        ...
        <textarea className="self-center bg-gray-100 w-lg h-72 mx-6 my-4 rounded-b-3xl pl-6 pt-6 outline-none resize-none w-11/12 sm:mx-2.5 sm:my-3 sm:h-[300px] text-sm sm:pl-3 sm:pt-4">
