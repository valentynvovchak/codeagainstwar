...
function ChallengeItem() {
  ...
  return (
    ...
    //   </button>
    // </div>
    <div className="flex justify-around font-semibold py-5 pl-4 border-b-2 last-of-type:border-b-0 hover:bg-gray-100 sm:text-sm sm:pl-1">
      <a className="pl-4 sm:pl-1 sm:hidden sm:text-xs">#1</a>
      <a>Matrix Multiplication</a>
      ...
      <Link to="/challenge">
        <button
          ...
          className="bg-blue-700 w-32 py-1 rounded-2xl font-semibold text-white shadow-md hover:shadow-xl active:scale-90 transition duration-150 text-center sm:w-14 sm:text-xs"
        >
          Start!
        </button>
      </Link>
